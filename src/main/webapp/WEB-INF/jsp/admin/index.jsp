...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/res/bjui/js/syntaxhighlighter-2.1.382/styles/shCore.css"/>
    <link type="text/css" rel="stylesheet" href="/res/bjui/js/syntaxhighlighter-2.1.382/styles/shThemeEclipse.css"/>
    <script type="text/javascript" src="/res/bjui/js/syntaxhighlighter-2.1.382/scripts/brush.js"></script>
    <link href="doc/doc.css" rel="stylesheet">
    <script type="text/javascript">
        $(function(){
            SyntaxHighlighter.config.clipboardSwf = '/res/bjui/js/syntaxhighlighter-2.1.382/scripts/clipboard.swf'
                ...
                <div class="bjui-pageHeader" style="background:#FFF;">
                    <div style="padding: 0 5px;">
                        ...
                        <div class="row alert alert-success" style="margin: 10px 10px 10px 10px;">
                            <h4 style="margin-bottom:20px;">欢迎使用YouMeHime网络卡密微商城程序&nbsp;<small>最好用的卡密微商城程序</small></h4>
                            <div class="col-md-6">
                                <h5>YouMeHim网络卡密微商城程序</h5>
                                <h5>数据中心：<a href="http://www.919dns.com/" target="_blank">http://www.919dns.com/</a></h5>
                                <h5>站长站：<a href="http://www.919zzz.com/" target="_blank">http://www.919zzz.com/</a></h5>
                            </div>
                            <div class="col-md-6">
                                <h5>客服QQ：2862489570</h5>
                                <h5>网络论坛：<a href="" target="_blank"></a></h5>
                            </div>
                        </div>
                    </div>
                </div>
...
<footer id="bjui-footer">Copyright &copy; 2015 - 2020 <a href="http://www.wefall.cn" target="_blank">YouMeHim</a>
</footer>
</body>
</html>