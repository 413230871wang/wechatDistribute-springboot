...
<div class="main_box">
    ...
    <div class="login_box">
        ...
        <div class="login_form">
            <form action="login.bl" class="ajax_form" method="post">
                <div class="form-group">
                    <label for="j_username" class="t">用户名：</label>
                    <input id="j_username" value="" name="name" dataType="require" alt="请输入用户名" type="text" class="form-control x319 in" autocomplete="off">
                </div>
                <div class="form-group">
                    <label for="j_password" class="t">密　码：</label>
                    <input id="j_password" value="" name="password" type="password" dataType="require" alt="请输入密码"  class="form-control x319 in">
                </div>
